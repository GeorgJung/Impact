...
\pgfdeclareimage[height=0.5cm]{university-logo}{Da.png}
...
\begin{frame}{Glyphs Method}
 ...
 \end{itemize}
 \centering{\includegraphics[scale=0.4]{glyphfinal.png}}
\end{frame}
...
\begin{frame}{Joint Positions Lists}
 ...
 \end{itemize}
 \centering{\includegraphics[scale=0.3]{stack.png}}
\end{frame}
\subsection{MCS UK}
\begin{frame}{MCS UK}
 \begin{itemize}
...
\begin{frame}{Summary}
  ...
  \item
    The \alert{Robust and Dynamic} requirement was not fully possible as Kinect has a lot of limitations.
  \item
