...
\lstinputlisting[language=C]{listings/StoreGesture.cs}
...
\lstinputlisting[language=C, firstline = 26, lastline = 36]{listings/xna.cs}
...
\lstinputlisting[language=C, firstline = 1, lastline = 13]{listings/DetectGesture.cs}
...
\lstinputlisting[language=C, firstline = 15, lastline = 74]{listings/DetectGesture.cs}
...
\subsection{MCS UK Solution Development Gesture Service}
